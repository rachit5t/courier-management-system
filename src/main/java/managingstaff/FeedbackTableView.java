 ...
 * @author kir7
 */
public class FeedbackTableView extends javax.swing.JFrame {

    /**
     * Creates new form Login
     */
    
    public FeedbackTableView() {
        initComponents();
        setResizable(false);
        readFromFile();
    ...
    private void initComponents() {
        ...
        trackOrderTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Feedback Id", "Feedback By", "Feedback For", "Date", "Text"
            }
        ) {
        ...
        jButton3.setText("Open in detail view");
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton3ActionPerformed(evt);
            }
        });
        jPanel5.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 60, 150, 30));
    ...
    File file = new File("Feedbacks.txt"); // new file instance
        if(!file.exists()){ try {
            ...
            Logger.getLogger(FeedbackTableView.class.getName()).log(Level.SEVERE, null, ex);
        }
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String feedback = (trackOrderTable.getValueAt(trackOrderTable.getSelectedRow(), 0).toString());
        setVisible(false);
        new FeedbackDetailedView(feedback).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FeedbackTableView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
