...
public class TrackOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        copyCellValue = new javax.swing.JButton();
        ...
        trackOrderTable.setColumnSelectionAllowed(true);
        ...
        jPanel5.add(searchLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 70, 100, 40));
        ...
        jPanel5.add(searchInput, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 80, 220, -1));

        copyCellValue.setText("Copy Cell value");
        copyCellValue.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                copyCellValueActionPerformed(evt);
            }
        });
        jPanel5.add(copyCellValue, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 80, -1, -1));
...
private void fixColumn(){
    ...
    private void copyCellValueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_copyCellValueActionPerformed
        // TODO add your handling code here:
        if (trackOrderTable.getSelectedRowCount() == 0){
            JOptionPane.showMessageDialog(null, "Please Select a cell.","ERROR!", JOptionPane.ERROR_MESSAGE);
        }
        String cellValue = (trackOrderTable.getValueAt(trackOrderTable.getSelectedRow(), trackOrderTable.getSelectedColumn()).toString());
        StringSelection selection = new StringSelection(cellValue);
        Toolkit kit = Toolkit.getDefaultToolkit();
        Clipboard clipboard = kit.getSystemClipboard();
        clipboard.setContents(selection, null);
        JOptionPane.showMessageDialog(null, "The string in the selected cell is copied.","INFORMATION!", JOptionPane.INFORMATION_MESSAGE);
    }//GEN-LAST:event_copyCellValueActionPerformed
...
DefaultTableModel tableModel;
    ...
    private javax.swing.JButton copyCellValue;
