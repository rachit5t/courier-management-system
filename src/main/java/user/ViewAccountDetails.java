...
public class ViewAccountDetails extends javax.swing.JFrame {
    ...
    String userId;
    public ViewAccountDetails(String userId) {
        this.userId = userId;
        initComponents();
        setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        jbTrackOrder.setText("Track Order");
    ...
    private void btnGetCurrentInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGetCurrentInfoActionPerformed
        ...
        try {
           ...
           Logger.getLogger(ViewAccountDetails.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAccountDetails("rachitDhakal").setVisible(true);
            }
        });
    }
